...
const HeartIcon = require('../assets/icons/heart-graphics-icon.png')
      ...
      <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-md">
          <strong className="block text-center text-xl font-bold text-gray-900 sm:text-3xl">
            Want us to email you with the latest blockbuster designs?
          </strong>
        ...
        <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
          ...
          <ul className="mt-8 space-y-4 text-sm">
            ...
            <li>
              <a
                className="group flex gap-1.5 justify-center md:justify-normal ltr:sm:justify-start rtl:sm:justify-end"
                href="/"
              >
                <span
        ...
        <div className="mt-16 border-t border-gray-100 pt-8">
          <p className="text-center text-xs/relaxed text-gray-500">
            ...
            <div className="flex flex-row justify-center items-center">
                ...
                <div><Image src={HeartIcon} alt="heart-icon" width={25} height={25}/></div>
                <div>by Sumanya.</div>
            </div>
        </div>
      </div>
